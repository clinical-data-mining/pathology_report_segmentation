...
class CombineAccessionDOPImpact(object):
    ...
    def _process_data(self):
        ...
        if self._fname_save is not None:
            ...
            self._obj_minio.save_obj(df=df_final, path_object=self._fname_save, sep='\t')
